...
module.exports = {
  ...
  async exec(cli, inter) {
    ...
    const deleteMessage = options.getNumber("delete-message") * 60 * 60 * 24;
        ...
        .then((m) => {
          ...
          coll.on("collect", async (i) => {
            if (i.customId == "ban:confirm") {
              ...
              await i.update({ embeds: [banningEmbed], components: [] });
          ...
          coll.on("end", () => {
            ...
            const timeoutEmbed = new EmbedBuilder()
              .setColor(cli.color)
              .setTitle("Ban Commands")
              .setDescription("No interaction received. ban cancelled")
              .setFooter({
                text: "You can close this message window now.",
              });
