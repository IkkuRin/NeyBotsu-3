...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addUserOption((opt) =>
      opt.setName("user").setDescription("Purge messages from a specific user"),
    ),
  async exec(cli, inter) {
    ...
    async function purge(messagefetch) {
      ...
      const responseEmbed = new EmbedBuilder()
        ...
        .setDescription(`Are you sure you want to purge ${responseMember}?`)
        .setFooter({
      ...
      inter
        ...
        .then((m) => {
          const coll = m.createMessageComponentCollector({ idle: 10000 });
          ...
          coll.on("collect", async (i) => {
            if (i.customId == "purge:confirm") {
              ...
              let deleted = await channel.bulkDelete(messagefetch, true);
              ...
              i.update({ embeds: [canceledEmbed], components: [] });
            }
          });
          ...
          coll.on("end", () => {
            ...
            const timeoutEmbed = new EmbedBuilder()
              ...
              .setDescription("No interaction received. kick cancelled")
              .setFooter({
                text: "You can close this message window now.",
              });
            ...
            m.edit({ embeds: [timeoutEmbed], components: [buttons] });
          });
        });
    }
