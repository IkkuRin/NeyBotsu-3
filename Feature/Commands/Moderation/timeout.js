...
module.exports = {
    ...
    async exec (cli, inter) {
        ...
        switch(format) {
            case 'secs': amount = amount * 1000; break;
            case 'mins': amount = amount * 1000 * 60; break;
            case 'hours': amount = amount * 1000 * 60 * 60; break;
            case 'days': ampunt = amount * 1000 * 60 * 60 * 24; break;
        };
        ...
        .setDescription(`Are you sure wants to Timeout ${member} for ${formattedTimer}${reason}?`)
        .setFooter({
        ...
        .then((msg) => {
            const coll = msg.createMessageComponentCollector({idle: 10000});
            ...
            coll.on('collect', async (i) => {
                if (i.custonId == 'timeout:confirm') {
                    ...
                    const finishedEmbed = new EmbedBuilder()
                        .setColor(cli.color)
                        .setTitle('Timeout Commands')
                        .setDescription(`${member} has been Timed Out for ${formattedTimer}${reason}!`)
                        .setFooter({
                    ...
                    .setColor(cli.color)
                    .setTitle('Timeout Commands')
                    .setDescription('No interaction recieved in the span of 10 seconds. Timeout Cancelled')
                    .setFooter({
                        text: 'You can close this message window now'
                    });
